...
public class m4a1s extends Card{
    private int radius = 60;


    public m4a1s(JPanel skins) {
        super(skins);
        this.SKIN_IMAGE = "/Users/tyoma_cho/Desktop/tapalka/assets/skins/blue/m4a1s.png";
        this.SKIN_NAME = "M4A1-S | Bright Water";
